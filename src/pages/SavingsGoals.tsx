...
const SavingsGoals = () => {
  ...
  const isLoading = isLoadingCircleGoals || isLoadingSoloGoals;
  const hasAnyGoals = (circleGoals && circleGoals.length > 0) || (soloGoals && soloGoals.length > 0);
              ...
              <TabsContent value="circle" className="space-y-8">
                {activeCircleGoals.length > 0 || pausedCircleGoals.length > 0 ? (
                  ...
                  <div className="bg-muted/30 rounded-lg p-8 text-center">
                    ...
                    <h3 className="mt-4 text-lg font-semibold">No circle goals</h3>
                    <p className="mt-2 text-sm text-muted-foreground max-w-md mx-auto">
